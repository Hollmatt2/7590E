# Text-rule evaluation, 2026-09-17

> Run while testing playbook keywords for Uncapped Liability (see `docs/playbook-selection.md`).
> The Uncapped Liability row below is the keyword experiment, not a text rule: it found none of the
> labeled clauses and every flag it raised was wrong. The keywords were removed after this run.
...
Method: the text rules in `core/rules.py`.
...
| Uncapped Liability | 23 | 0 | 0% | 3 | 3 | 100% |

Not measured (no text rule): Cap On Liability.
...
- *KitovPharmaLtd_20190326_20-F_EX-4.15_11584449_EX-4.15_Manufa*: Nothing in this Section ​8.7 shall operate to limit or exclude any liability under Section ​8.5 with respect to a Claim, or for fraud, or for breach by a Party of the provisions of Article ​7.
...
Wrong flags (flagged, not labeled):
- *AtnInternationalInc_20191108_10-Q_EX-10.1_11878541_EX-10.1_M*: "Subcontractor" means any Person (including an agent) supplying labor or materials to perform any or all of Vendor's obligations under this Agreement, including any Person at any tier of subcontractors, and shall not be limited to those Per
- *HC2HOLDINGS,INC_05_14_2020-EX-10.1-COOPERATION AGREEMENT*: and (c) the terms "person" or "persons" mean any individual, corporation (including not-for-profit), general or limited partnership, limited liability or unlimited liability company, joint venture, estate, trust, association, organization o
- *AIRSPANNETWORKSINC_04_11_2000-EX-10.5-Distributor Agreement*: Such efforts shall include, but shall not be limited to, that advertising within the Territory which is reasonably necessary.
